...
const Hero = React.memo(() => {
    ...
    return (
        <div className="relative">
            ...
            <div id="herobody" className="container w-full md:w-fit absolute z-10 top-[50%] left-[50%] md:left-[65%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-8 text-center text-white">
                <p className="inter heroTextReveal text-3xl">ADCORE CREATIVE (PVT) Ltd</p>
                <h2 className="cormorant-garamond heroTextReveal text-6xl">Elegant Ideas.</h2>
                <h2 className="cormorant-garamond heroTextReveal text-6xl">Enduring Impact.</h2>
                <p className="inter heroTextReveal max-md:w-80 max-lg:w-100 text-2xl font-light">Advertising & Creative Consultancy | Since 2009</p>
                <a href="#about" id="btn"
                    ...
                    <span
                        className="inter relative w-full text-left transition-colors duration-300 ease-in-out group-hover:text-black text-xl">Discover Our Approach</span>
                </a>
                <div id="scroll">
