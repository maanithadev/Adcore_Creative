...
const ImageGrid = React.memo(() => {
    return (
        <div id="imageGrid" className="w-full h-fit max-lg:hidden bg-[#0a0a0a]">
            <div className="container mx-auto  w-full h-full grid lg:grid-cols-2 lg:grid-rows-2 grid-cols-1 grid-rows-4">
